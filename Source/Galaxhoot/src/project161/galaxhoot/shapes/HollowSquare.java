...
/**
 * The Class HollowSquare.
 */
public class HollowSquare {

	/** The vertices. */
	protected float vertices[] = { -68.0f, 41.0f, 0.0f, // 0, Top Left
			-68.0f, -41.0f, 0.0f, // 1, Bottom Left
			68.0f, -41.0f, 0.0f, // 2, Bottom Right
			68.0f, 41.0f, 0.0f, // 3, Top Right
	};

	/** The indices. */
	protected short[] indices = { 0, 1, 1, 2, 2, 3, 3, 0 };
	...
	/**
	 * Instantiates a new hollow square.
	 */
	public HollowSquare() {
